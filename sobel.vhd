...
temp_y_1 <= ( '0' & sobel_window_3_by_3(0,0) & '0') + ( sobel_window_3_by_3(0,1) & "00") + ( '0' & sobel_window_3_by_3(0,2) & '0'); -- 2*win(0,0) + 4*win(0,1) + 2*win(0,2)

temp_y_2 <= ( '0' & sobel_window_3_by_3(2,0) & '0') + ( sobel_window_3_by_3(2,1) & "00") + ( '0' & sobel_window_3_by_3(2,2) & '0'); -- 2*win(2,0) + 4*win(2,1) + 2*win(2,2)
...
--  x direction
--
temp_x_1 <= ( '0' & sobel_window_3_by_3(0,0) & '0') + ( sobel_window_3_by_3(1,0) & "00") + ( '0' & sobel_window_3_by_3(2,0) & '0'); -- 2*win(0,0) + 4*win(1,0) + 2*win(2,0)

temp_x_2 <= ( '0' & sobel_window_3_by_3(0,2) & '0') + ( sobel_window_3_by_3(1,2) & "00") + ( '0' & sobel_window_3_by_3(2,2) & '0'); -- 2*win(0,2) + 4*win(1,2) + 2*win(2,2)
